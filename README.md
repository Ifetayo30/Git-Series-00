...
Je débute dans l'utilisation de Git et de GitHub et je souhaite mieux comprendre la gestion des versions et l'organisation de mes projets.ans le cadre de mon Master 2 en Ingénierie des Dispositifs pour la Santé, ces outils seront utiles pour gérer mes projets de programmation et d'analyse de données.
